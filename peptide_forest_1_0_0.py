...
# [TRISTAN] Parameters
# -p """{'D:\PyCharmProjects\peptideForest\data\Offset_6_7ppm__04854_F1_R8_P0109699E13_TMT10_mascot_dat2csv_1_0_0_accepted_pmap_unified.csv': {'engine': 'mascot', 'score_col': 'Mascot:Score',}, 'D:\PyCharmProjects\peptideForest\data\Offset_6_7ppm__04854_F1_R8_P0109699E13_TMT10_omssa_2_1_9_pmap_unified.csv': {'engine': 'omssa', 'score_col': 'OMSSA:pvalue',}, 'D:\PyCharmProjects\peptideForest\data\Offset_6_7ppm__04854_F1_R8_P0109699E13_TMT10_msgfplus_v2018_06_28_pmap_unified.csv': {'engine': 'msgfplus', 'score_col': 'MS-GF:SpecEValue',}, 'D:\PyCharmProjects\peptideForest\data\Offset_6_7ppm__04854_F1_R8_P0109699E13_TMT10_xtandem_vengeance_pmap_unified.csv': {'engine': 'xtandem', 'score_col': 'X\\!Tandem:hyperscore',}, 'D:\PyCharmProjects\peptideForest\data\Offset_6_7ppm__04854_F1_R8_P0109699E13_TMT10_msfragger_20190222_pmap_unified.csv': {'engine': 'msfragger', 'score_col': 'MSFragger:Hyperscore',},}""" -o "tmp_out.csv" -pd "./plots/"
...
def main(
    ...
    if mindsai_csv is not None:
        ...
        # [TRISTAN] Parameter-Import nur mit Single-Quotations und JSON requires doppelte. So ist es einfacher.
    ...
    PSMs_engine_cv = (
        {}
    )  # store engine results: the engine used as the initial ordering of PSMs
    feature_importance = (
        {}
    )  # store dataframes containing the importance of the features used
    ...
    model_type = (
        f"{classifier} - all data - cv method - top only - from {initial_engine}"
    )
    ...
    (
        ...
        PSMs[model_type],
        PSMs_avg[model_type],
        PSMs_engine_cv[initial_engine],
        df_training,
        feature_importance[model_type],
    ) = fit_models.fit_model(
        classifier,
        feature_cols,
        df_training,
        n_train=n_train,
    ...
    # get q-values
    df_training = analyse_results.calc_all_final_q_vals(
        df_training, from_method=initial_engine
    )

...
df = pd.DataFrame(
    {
        ...
        "delta_score_2_delta_type": [1, 2, 3, 4, 2],
        "delta_score_3_delta_type": [4, 3, 1, 1, 2],
...
def test_combine_engine_data():
    ...
    ref_new_cols = {
        ...
        "delta_score_2_A",
        "delta_score_2_B",
        "delta_score_2_delta_type_A",
        "delta_score_2_delta_type_B",
        "delta_score_3_A",
        "delta_score_3_B",
        "delta_score_3_delta_type_A",
        "delta_score_3_delta_type_B",
    }
